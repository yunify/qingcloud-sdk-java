...
public class EIPService {
    ...
    /**
      ...
      */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public GetEIPMonitorOutput getEIPMonitor(GetEIPMonitorInput input) throws QCException {
        if (input == null) {
            input = new GetEIPMonitorInput();
        }
        Map context = new HashMap();
        context.put(QCConstant.ENV_CONTEXT_KEY, this.envContext);
        context.put("OperationName", "GetEIPMonitor");
        context.put("APIName", "GetEIPMonitor");
        context.put("ServiceName", "GetMonitor");
        context.put("RequestMethod", "GET");
        context.put("RequestURI", "/GetEIPMonitor");

        input.setAction("GetEIPMonitor");
        if (QCStringUtil.isEmpty(this.zone)) {
            input.setZone(this.envContext.getZone());
        } else {
            input.setZone(this.zone);
        ...
        Object backModel = ResourceRequestFactory.getResourceRequest().sendApiRequest(context, input,GetEIPMonitorOutput.class);
        if(backModel != null){
            return (GetEIPMonitorOutput)backModel;
        }
        return null;
    }
     ...
     /**
       ...
       */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public void getEIPMonitor(GetEIPMonitorInput input, ResponseCallBack<GetEIPMonitorOutput> callback) throws QCException {
        if (input == null) {
            input = new GetEIPMonitorInput();
        }
        Map context = new HashMap();
    ...
    public static class GetEIPMonitorInput extends IaasParamBody {
        // Required
    ...
    public static class GetEIPMonitorOutput extends OutputModel {
        private String action;
