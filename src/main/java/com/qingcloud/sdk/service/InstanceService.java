...
public class InstanceService {
    ...
    /**
      ...
      */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public GetInstanceMonitorOutput getInstanceMonitor(GetInstanceMonitorInput input) throws QCException {
        if (input == null) {
            input = new GetInstanceMonitorInput();
        }
        Map context = new HashMap();
        context.put(QCConstant.ENV_CONTEXT_KEY, this.envContext);
        context.put("OperationName", "GetInstanceMonitor");
        context.put("APIName", "GetInstanceMonitor");
        context.put("ServiceName", "GetMonitor");
        context.put("RequestMethod", "GET");
        context.put("RequestURI", "/GetInstanceMonitor");

        input.setAction("GetInstanceMonitor");
        if (QCStringUtil.isEmpty(this.zone)) {
            input.setZone(this.envContext.getZone());
        } else {
            input.setZone(this.zone);
        ...
        Object backModel = ResourceRequestFactory.getResourceRequest().sendApiRequest(context, input,GetInstanceMonitorOutput.class);
        if(backModel != null){
            return (GetInstanceMonitorOutput)backModel;
        }
        return null;
    }
     ...
     /**
       ...
       */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public void getInstanceMonitor(GetInstanceMonitorInput input, ResponseCallBack<GetInstanceMonitorOutput> callback) throws QCException {
        if (input == null) {
            input = new GetInstanceMonitorInput();
        }
        Map context = new HashMap();
    ...
    public static class GetInstanceMonitorInput extends IaasParamBody {
        // Required
    ...
    public static class GetInstanceMonitorOutput extends OutputModel {
        private String action;
